...
import math.cluster.evaluation.Variance;
...
public class KMeansPlusPlusClusterer<T extends Clusterable> extends Clusterer<T> {
    ...
    public List<CentroidCluster<T>> cluster(final Collection<T> points)
    	...
    	if(null == points){
    		throw new Exception("data set should not null");
    	}

        // number of clusters has to be smaller or equal the number of data points
        if (points.size() < k) {
            throw new Exception("points is too small");
        }
                ...
                if (cluster.getPoints().isEmpty()) {
                    switch (emptyStrategy) {
                        ...
                        case FARTHEST_POINT :
                            ...
                            break;
                        default :
                            throw new Exception("ConvergenceException");
                    }
                    emptyCluster = true;
                } else {
     ...
     * @throws ConvergenceException if clusters are all empty
     */
    private T getFarthestPoint(final Collection<CentroidCluster<T>> clusters) throws Exception {
