...
public class DateUtil {
	...
	public static final String HIS = "HH:mm:ss";
	public static final String INT_SIMPLE = "yyyyMMddHHmmss";
	public static final String INT_YMD = "yyyyMMdd";
	public static final String INT_HIS = "HHmmss";
	...
	public static String formatDateTime(Date date) {
		return format(date, DateUtil.SIMPLE);
	}
	...
	public static String formatDate(Date date) {
		return format(date, DateUtil.YMD);
	}
	...
	public static String formatTime(Date date) {
		return format(date, DateUtil.HIS);
	}
