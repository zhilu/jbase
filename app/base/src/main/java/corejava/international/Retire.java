...
class RetireFrame extends JFrame
{
   ...
   public void setCurrentLocale(Locale locale)
   {
      ...
      res = ResourceBundle.getBundle("corejava.international.RetireResources", currentLocale);
      resStrings = ResourceBundle.getBundle("corejava.international.RetireStrings", currentLocale);
