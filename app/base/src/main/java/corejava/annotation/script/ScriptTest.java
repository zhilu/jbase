package corejava.annotation.script;
...
public class ScriptTest {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					final String frameClassName = args.length < 2 ? "corejava.annotation.buttons1.ButtonFrame" : args[1];
	 ...
	 * 
	 * @param beanName
	 *            the name of the bean to which the listener should be added
	 * @param eventName
	 *            the name of the listener type, such as "action" or "change"
	 * @param scriptCode
	 *            the script code to be executed
	 * @param engine
	 *            the engine that executes the code
	 * @param bindings
	 *            the bindings for the execution
